import { EyeOff, Key, Lock, Send, Server, Shield } from 'lucide-react';
    ...
    <Layout maxWidth="max-w-2xl">
      <div className="prose dark:prose-invert py-4 px-0 md:px-0">
        ...
        <p className="text-sm md:text-base">
          Create instant encrypted notes just by typing a title. No signups, no passwords, no server
          storing your raw text.
        </p>
          ...
          <ol className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
            <li className="flex gap-3 items-start">
              ...
              <span className="min-w-0 break-words">
                You type a title (e.g., "My Secret Recipe")
              </span>
            </li>
            <li className="flex gap-3 items-start">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 text-primary font-bold text-xs flex items-center justify-center mt-0.5">
              ...
              <span className="min-w-0 break-words">
                Your browser uses <strong>HKDF</strong> (a cryptographic key derivation function) to
                create <em>two separate values</em> from your title
              </span>
            </li>
            <li className="flex gap-3 items-start">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-primary/20 text-primary font-bold text-xs flex items-center justify-center mt-0.5">
              ...
              <div className="min-w-0 break-words">
                <strong>Note ID</strong> → sent to the server as a public identifier
                <br />
            ...
            <li className="flex gap-3 items-start">
              ...
              <span className="min-w-0 break-words">
                Your content is encrypted with <strong>AES-256-GCM</strong> before leaving your
                device
              </span>
            </li>
          </ol>
        ...
        <ul className="text-sm md:text-base">
          <li>
            <strong>Real-Time Sync:</strong> Share the title with others to collaborate instantly.
            Anyone with the title can decrypt.
          </li>
          <li>
            <strong>Zero Knowledge:</strong> The server only sees an encrypted blob — it cannot read
            your notes, even if compelled.
          </li>
        </ul>

        <h3 className="text-lg md:text-xl">🔐 Send a Secret</h3>
        <p className="text-sm md:text-base">
          Need to share a password, API key, or sensitive message? <strong>Send</strong> creates a
          one-time, self-destructing secret link.
        </p>
        ...
        <ul className="text-sm md:text-base">
          <li>
            <strong>Expiring Links:</strong> Set secrets to expire after 1 hour, 1 day, 7 days, or
            30 days.
          </li>
          <li>
            <strong>Burn After Reading:</strong> Optionally delete the secret immediately after it's
            opened once.
          </li>
          <li>
            <strong>No Server Access:</strong> Even OtterSeal's server cannot decrypt your secrets —
        ...
        <div className="not-prose grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4 my-5">
          <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 md:p-4">
            <h4 className="font-semibold text-green-800 dark:text-green-400 text-xs md:text-sm mb-1">
              What We Store
            </h4>
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-3 md:p-4">
            <h4 className="font-semibold text-red-800 dark:text-red-400 text-xs md:text-sm mb-1">
              What We Never See
            </h4>
        ...
        <ul className="text-sm md:text-base">
          <li>
            <strong>HKDF-SHA256:</strong> We use HMAC-based Extract-and-Expand Key Derivation
            Function for cryptographically secure domain separation.
          </li>
          <li>
            <strong>Independent Derivation:</strong> The Note ID and Encryption Key are
            mathematically unrelated — knowing one reveals nothing about the other.
          </li>
          <li>
            <strong>AES-256-GCM:</strong> Industry-standard authenticated encryption with 256-bit
            keys and built-in integrity checking.
          </li>
          <li>
            <strong>Client-Side Only:</strong> All encryption and decryption happens in your
            browser. Our server is just a dumb encrypted blob store.
          </li>
        </ul>
