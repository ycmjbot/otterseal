      ...
      >
        ...
        <div className="p-3 border-t border-gray-200 dark:border-gray-800 space-y-0.5">
          <Link
            to="/about"
            onClick={() => onClose()}
            className="flex items-center gap-3 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
          >
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 text-xs text-gray-500 text-center">
          <p>
            Built by{' '}
            <a
              href={import.meta.env.VITE_AUTHOR_URL || 'https://ycmj.bot'}
              target="_blank"
              rel="noreferrer"
